...
Page({
    ...
    data: {
        ...
        rogincol: 0, //初始选择的颜色
        carid: '',
        swiper1_txt: ['共享全球供应商体系', '日产HR16发动机', '日产XTRONIC CVT无级变速器', 'Zone Body区域组合+1200Mpa高强刚车身', '加强版6安全气囊防护系统', 'ASCD定速巡航', 'HSA上坡起步辅助系统', '博世9.1版ESP车身电子稳定系统', '日产同平台开发生产'], //部件名称
		...
		t70_swiper4_txt: ['先进的XTRONIC CVT无级变速器', '多连杆独立后悬挂', 'ESP车身电子稳定系统', '日产全球引擎MR20发动机', '先进的XTRONIC CVT无级变速器', '多连杆独立后悬挂', 'ESP车身电子稳定系统', '日产全球引擎MR20发动机'], //部件名称
