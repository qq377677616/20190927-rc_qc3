...
//ev试驾   首页数据
const evIndex = (data) => {
    let url = `${SERVICE}/api3/Evtestdrive/get_activity_info`
    return new Promise((resolve, reject) => {
        _request.request({
                url,
                data
...
const submitData = (data) => {
    let url = `${SERVICE}/api3/Evtestdrive/submit_data`
    return new Promise((resolve, reject) => {
        _request.request({
                url,
                data
...
//ev试驾   助力页面
const helpList = (data) => {
    let url = `${SERVICE}/api3/Evtestdrive/help_list`
    return new Promise((resolve, reject) => {
        _request.request({
                url,
                data
...
//ev试驾   助力操作
const evHelp = (data) => {
    let url = `${SERVICE}/api3/Evtestdrive/help`
    return new Promise((resolve, reject) => {
        _request.request({
                url,
                data
...
//ev试驾   获取商品id
const getHelpPrize = (data) => {
    let url = `${SERVICE}/api3/Evtestdrive/get_help_prize`
    return new Promise((resolve, reject) => {
        _request.request({
                url,
                data
